...
!  end if
   ...
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_current_vertex',tread,'INT')
   if(tread==1) dtset%dmft_resp_current_vertex=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_mode',tread,'INT')
   if(tread==1) dtset%dmft_resp_mode=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_nboson',tread,'INT')
   if(tread==1) dtset%dmft_resp_nboson=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_niw_vertex',tread,'INT')
   if(tread==1) dtset%dmft_resp_niw_vertex=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_realaxis_backend',tread,'INT')
   if(tread==1) dtset%dmft_resp_realaxis_backend=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_soc_required',tread,'INT')
   if(tread==1) dtset%dmft_resp_soc_required=intarr(1)
   call intagm(dprarr,intarr,jdtset,marr,1,string(1:lenstr),'dmft_resp_spinflip',tread,'INT')
   if(tread==1) dtset%dmft_resp_spinflip=intarr(1)
